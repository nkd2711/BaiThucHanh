...
public class App112 {
  public static void main(String[] args) {
    ...
    Student student1 = new Student("Kiet", 8);
    Student student2 = new Student("Long", 2);
    Student student3 = new Student("Hung", 4);
    Student student4 = new Student("Thien", 7); 
    Student student5 = new Student("Dang", 9); 
